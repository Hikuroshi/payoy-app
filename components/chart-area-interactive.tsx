  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        ...
        <CardAction>
          <ToggleGroup type="single" value={selectedTimeRange} onValueChange={handleTimeRangeChange} variant="outline" className="hidden *:data-[slot=toggle-group-item]:px-4! @[767px]/card:flex">
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer config={chartConfig} className="aspect-auto h-62.5w-full">
