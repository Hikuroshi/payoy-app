...
export function CategoryForm({
  ...
  return (
    <Card
      ...
      key={state.submissionId ?? `${mode}-${category?.id ?? "new"}`}
    >
      <CardHeader>
        <CardTitle>{isEdit ? "Edit Kategori" : "Tambah Kategori"}</CardTitle>
        <CardDescription>
          {isEdit
            ? "Perbarui nama kategori makanan."
            : "Kategori membantu owner mengelompokkan menu makanan."}
        </CardDescription>
      </CardHeader>
        ...
        <CardContent>
          <FieldGroup>
            ...
            <Field data-invalid={!!nameError}>
              ...
              />
              <FieldDescription>
                Contoh: Minuman, Makanan Berat, Dessert.
              </FieldDescription>
